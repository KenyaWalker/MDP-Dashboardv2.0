...
// Serve static files - for Railway deployment, files are in root directory
...
// Serve success.html directly
app.get('/success.html', (req, res) => {
    const successPath = path.join(__dirname, 'success.html');
    res.sendFile(successPath);
});

// Serve all other static files (handled by express.static)

// Fallback: Serve main survey form for all other unknown routes
app.get('*', (req, res) => {
